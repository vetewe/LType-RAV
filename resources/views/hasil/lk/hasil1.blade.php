...
<body>
    <div class="container">
        ...
        <div class="container">
            ...
            <h2>Sang Pencerita</h2>
            <div class="vak">VAK</div>
            <img src="assets/gmbr/ICON_LK_PNG.png" alt="Astronaut" class="astronaut">
            <p>Seorang guru yang hebat, suka memperlihatkan dan menceritakan, ingin bersinar/tampil cemerlang.</p>
            <a href="/profil1"><button class="button">Lihat Profil Anda</button></a>
        </div>
    </div>
</body>
</html>
