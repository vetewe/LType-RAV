...
<body>
    <div class="container">
        ...
        <div class="container">
            ...
            <h2>Sang Penyelidik</h2>
            <div class="vak">KVA</div>
            <img src="assets/gmbr/ICON_LK_PNG.png" alt="Astronaut" class="astronaut">
            <p>Seorang mitra yang hebat yang bekerja dengan baik dengan orang lain. Ingin menciptakan jejaring diantara orang orang dan membuat hubungan-hubungan.</p>
            <a href="/profil4"><button class="button">Lihat Profil Anda</button></a>
        </div>
    </div>
</body>
</html>
