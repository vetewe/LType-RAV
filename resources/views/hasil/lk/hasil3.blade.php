...
<body>
    <div class="container">
        ...
        <div class="container">
            ...
            <h2>Sang Komunikator</h2>
            <div class="vak">AVK</div>
            <img src="assets/gmbr/ICON_LK_PNG.png" alt="Astronaut" class="astronaut">
            <p>Seorang komunikator hebat yang suka sekali bertukar gagasan. ingin menolong.</p>
            <a href="/profil5"><button class="button">Lihat Profil Anda</button></a>
        </div>
    </div>
</body>
</html>
